...
PROC_DDIR=data/ted_processed/aze_spm_flores_aug${augID}/
PROC_DDIR_PRE=data/ted_processed/aze_spm_flores_aug${augID_pre}/
BINARIZED_DDIR=data/ted_binarized/aze_flores_aug${augID}/
...
RAW_DATA=data/ted_raw_aug/aze_eng/
BINARIZED_DATA=data/ted_binarized/aze_flores_aug${augID}/eng_aze/
PRETRAINED_DIR=checkpoints/flores101_mm100_175M
MODEL_DIR=checkpoints/ted_aze_flores_aug${augID_pre}/eng_aze/
COMET_DIR=comet
mkdir -p $MODEL_DIR
...
fairseq-generate $BINARIZED_DATA \
    ...
    --beam 5  | grep ^H | cut -c 3- | sort -n | cut -f3- > "$RAW_DATA"/ted-train.synth-QED.aze
