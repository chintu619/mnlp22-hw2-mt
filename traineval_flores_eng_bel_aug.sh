...
BINARIZED_DATA=data/ted_binarized/bel_flores_aug${augID}/eng_bel/
PRETRAINED_DIR=checkpoints/flores101_mm100_175M
MODEL_DIR=checkpoints/ted_bel_flores_aug${augID}/eng_bel/
COMET_DIR=comet
mkdir -p $MODEL_DIR

if [ "$#" -eq 2 ]; then
    FINETUNED_MODEL=checkpoints/ted_bel_flores_aug${augID_pre}/eng_bel/checkpoint_best.pt
else
